...
To launch this service locally via command line run `mvn spring-boot:run`, then connect to `localhost:9494`
...
- Run: `docker run -p 9494:9494 registry.prod.auction.local:5000/homes-ms-retail:DEV`
...
- Run: `docker run -p 9494:9494 registry.prod.auction.local:5000/homes-ms-retail`
