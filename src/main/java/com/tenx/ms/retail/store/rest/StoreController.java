...
import com.tenx.ms.commons.rest.ResponseEntityBuilder;
...
public class StoreController {
    ...
    public ResponseEntity<Void> createStore(@ApiParam(name = "store",
                                            value="JSON data of the store created",
                                            required = true)
                                            @Validated @RequestBody Store store) {
        return ResponseEntityBuilder.created(storeService.createStore(store));
    }
